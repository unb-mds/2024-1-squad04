<template>
    <div class="container">
      <div class="notas">
        ...
        <div class="rating">
          <input type="radio" name="notaExperiencia" id="star1-5" value=5 @change="emitirAvaliacao" v-model="rating.notaExperiencia" style="--c: #0a745b;" />
          <input type="radio" name="notaExperiencia" id="star1-4" value=4 @change="emitirAvaliacao" v-model="rating.notaExperiencia" style="--c: #0a745b;" />
          <input type="radio" name="notaExperiencia" id="star1-3" value=3 @change="emitirAvaliacao" v-model="rating.notaExperiencia" style="--c: #0a745b;" />
          <input type="radio" name="notaExperiencia" id="star1-2" value=2 @change="emitirAvaliacao" v-model="rating.notaExperiencia" style="--c: #0a745b;" />
          <input type="radio" name="notaExperiencia" id="star1-1" value=1 @change="emitirAvaliacao" v-model="rating.notaExperiencia" style="--c: #0a745b;" />
        </div>
      </div>
