    ...
    <div class="container-frame">
        <div class="container">
            ...
            <div id="sidebar">
                ...
                <div class="selectdiv">
                    <div>
                        <label class="selecionarmaterias"
                            ...
                            <div class="personal-container">
                                ...
                                <div class="local-professor">
                                    <div class="container-linha-info">
                                        ...
                                        <p
                                            class="info-text"
                                            id="ajuste-localizacao-professor"
                                        >
                                            Brasília, UnB Gama
                                        </p>
                                    </div>
...
@media only screen and (max-width: 1128px) {
    ...
    .profile-pic {
        width: 50%; /* Faz a imagem do perfil ocupar toda a largura */
    }
