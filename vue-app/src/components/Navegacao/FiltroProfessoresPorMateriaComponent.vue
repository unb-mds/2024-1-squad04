<template>
    <div class="container">
        <div class="icon-have">
            <img src="../../assets/icons/pagina_professor/filter.svg" class="icon"  alt="filtro" @click="abrirFilterBox">
      
            <div  v-if="materiaSelecionada !== ''" class="have-filter"  >
                1
            </div>
        </div>
        ...
        <div v-if="isOpen" class="filter-box">
            ...
            <div class="itens">
                ...
                v-for="(materia, index) in filteredMaterias.slice(0,4)" 
                    ...
                    <div class="item-check" :class="{ checked: materiaSelecionada === materia.cod_materia }">
                    </div>
                    <p class="item-name">
                        {{materia.nome}}
                    </p>
            ...
            <div class="button-and-limpar">
                ...
                <p @click="limparFiltro()" class="limpar-filtro">
                    Limpar Filtro
                </p>
            </div>
    ...
    computed: {
            filteredMaterias() {
                ...
                return this.materias.filter(materia => {
                    const normalizedMateria = materia.nome.toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g, "");
